...
app.config['MAIL_USERNAME'] = 'nireshkumarniresh@gmail.com'  # Your email
app.config['MAIL_PASSWORD'] = 'Niresh@123'  # Your email password
app.config['MAIL_DEFAULT_SENDER'] = 'nireshkumarniresh@gmail.com'  # Your email
